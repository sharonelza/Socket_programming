...
int main(int argc, char *argv[])
{
    ...
    sockfd = socket(AF_INET, SOCK_STREAM, 0);          /*Socket function is used to create a socket
                                                        The above code will create a socket of
    ...
    serv_addr.sin_addr.s_addr = INADDR_ANY;                //The sockaddr_in has a member called sin_addr
    ...
    close(newsockfd);
    close(sockfd);             //It is used to close the socket
    return 0;
}
